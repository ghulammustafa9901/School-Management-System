Public Class StudentDetailForm
    ...
    Private Sub StudentDetailForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        initial_program()
    End Sub
    ...
    Private Sub combo_s_roll_no_GotFocus(sender As Object, e As EventArgs) Handles combo_s_roll_no.GotFocus
        ...
        '    MsgBox("Please Select a Class.", vbInformation, msgtitle)
        '    Exit Sub
        'End If
    ...
    Private Sub combo_s_roll_no_DropDownClosed(sender As Object, e As EventArgs) Handles combo_s_roll_no.DropDownClosed
        ...
        txt_s_nationality.Text = CStr(rsdb(8).Value)
        txt_s_city.Text = CStr(rsdb(9).Value)
        txt_s_BP.Text = CStr(rsdb(10).Value)
        txt_s_religion.Text = CStr(rsdb(11).Value)
